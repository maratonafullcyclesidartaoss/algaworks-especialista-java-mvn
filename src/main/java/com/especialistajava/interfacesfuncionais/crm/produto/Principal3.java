...
//        Function<Produto, Integer> functionPorQuantidade = produto -> produto.getQuantidade();
//        Function<Produto, String> functionPeloNome = produto -> produto.getNome();
//
//        produtos.sort(Comparator.comparing(functionPorQuantidade).thenComparing(functionPeloNome));
