...
public class ServicoDeVenda {
    ...
    public static final int CODIGO_INICIAL = 0;
    ...
    public ServicoDeVenda() {
        ...
        var venda2 = new Venda(gerarProximoCodigo(), new Cliente("Mario de Souza"));
...
//            int codigoAtual = venda.getCodigo() == null ? 0 : venda.getCodigo().intValue();
